                      ...
                      <div className="flex items-start justify-between mb-4 gap-4">
                        ...
                        <div className="flex items-center gap-2 ml-4">
                          <Link
                            ...
                            className="flex items-center gap-2 px-5 py-2.5 bg-brand-green text-white hover:bg-brand-green-dark rounded-xl transition-all font-medium shadow-sm hover:shadow-md"
                          >
                          ...
                          <button
                            ...
                            className="flex items-center gap-2 px-4 py-2.5 border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 rounded-xl transition-all font-medium shadow-sm hover:shadow-md"
                            title={expanded ? 'Hide remarks' : 'Show remarks'}
                          >
