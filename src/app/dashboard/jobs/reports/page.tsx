        ...
        <main className="max-w-[1600px] mx-auto px-3 sm:px-6 lg:px-8 py-6 pb-10">
          ...
          {isLoading ? (
            ...
            <>
              ...
              {totalPages > 1 && (
                <div className="grid grid-cols-1 gap-3 mt-4 px-6 py-4 border-t-2 border-slate-200 bg-gradient-to-r from-slate-50 to-white lg:grid-cols-2 lg:items-center rounded-b-2xl">
