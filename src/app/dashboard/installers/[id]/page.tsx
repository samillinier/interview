...
export default function InstallerProfileViewPage() {
  ...
  const [accountType, setAccountType] = useState<'installer' | 'estimator'>('installer')
  ...
  useEffect(() => {
    if (installer && !isEditing) {
      ...
      setAccountType(installer.accountType === 'estimator' ? 'estimator' : 'installer')
                    ...
                    <>
                      ...
                      >
                        ...
                        <div className="rounded-xl border border-brand-green/20 bg-gradient-to-br from-brand-green/5 to-white p-4">
                          ...
                          {interviewRecapLoading ? (
                          ...
                          ) : !interviewRecap?.summary ? (
                            <p className="py-2 text-sm text-slate-500">
                              No AI interview summary yet for this installer.
                            </p>
                          ) : (
                            <div className="space-y-3">
                              ...
                              {interviewRecap.watchNotes.length > 0 ? (
                                <div className="space-y-2">
                                  <p className="text-[11px] font-bold uppercase tracking-wide text-amber-700">
                                    Don’t miss
                                  </p>
                                  {interviewRecap.watchNotes.map((note) => (
                                    <div
                                      key={note}
