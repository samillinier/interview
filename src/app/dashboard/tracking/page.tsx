                  ...
                  <thead className="sticky top-[-1.5rem] z-20 bg-gradient-to-r from-slate-50 to-slate-100/50 border-b-2 border-slate-200">
                    <tr>
                      ...
                      {visibleDefs.map((def) => (
                        <th
                          key={def.id}
                          className={`sticky top-[-1.5rem] z-20 bg-slate-50 px-0.5 py-2 text-center border-l border-slate-200 align-bottom ${
                        ...
                        >
                          <div className="flex flex-col items-center justify-end gap-0.5 mx-auto">
                            ...
                            {def.subtitle ? (
                              <span className="text-[7px] font-medium text-slate-500 leading-snug text-center normal-case tracking-normal max-w-[3.2rem]">
                                {def.subtitle}
                              </span>
                            ) : null}
                          </div>
