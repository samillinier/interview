    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <div className={`flex-1 transition-all duration-300 ${sidebarOpen ? 'lg:ml-64' : 'lg:ml-20'} w-full`}>
        <header className="bg-white/80 backdrop-blur-md border-b border-slate-200/50 sticky top-0 z-20 shadow-sm">
          <div className="px-4 lg:px-6 xl:px-10 pt-16 lg:pt-6 pb-6">
        ...
        <main className="max-w-[1920px] mx-auto px-3 sm:px-6 lg:px-8 xl:px-10 pb-8">
          <div className="grid grid-cols-1 xl:grid-cols-[minmax(420px,32%)_1fr] gap-5 xl:gap-6">
            <motion.section
