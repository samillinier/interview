...
export default function BolPage() {
  ...
  const confirmDelete = async () => {
    ...
    try {
      const res = await fetch(`/api/pad-orders?id=${orderId}`, { method: 'DELETE' })
      const data = await res.json()
      if (data.success) {
                            ...
                            <div className="flex items-center justify-between gap-2">
                              ...
                              <select
                                ...
                                onChange={(e) => {
                                  ...
                                  else if (val === 'delete') deleteOrder(order.id)
                                }}
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center">
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-bold text-slate-800 mb-1">Delete Pad Order</h3>
              <p className="text-sm text-slate-500 mb-6 leading-relaxed">
                Are you sure you want to delete this pad order? This action cannot be undone.
              </p>
