...
const corporateGroups = [
  {
    ...
    cards: [
      ...
      {
        title: 'Documents',
        description: 'Store and organize corporate documents: BTR, firm lead certificate, license, LRRP, and liability.',
        href: '/dashboard/corporate/documents',
        icon: FileCheck,
        cta: 'Open documents',
        highlights: ['BTR', 'Licence', 'LRRP', 'Liability', 'Firm lead'],
      },
    ],
  },
]
