...
function buildClaimData(body: any, email: string, isCreate: boolean) {
  ...
  return {
    ...
    insuranceCompany: typeof body.insuranceCompany === 'string' ? body.insuranceCompany.trim() || null : null,
    adjusterName: typeof body.adjusterName === 'string' ? body.adjusterName.trim() || null : null,
    adjusterPhone: typeof body.adjusterPhone === 'string' ? body.adjusterPhone.trim() || null : null,
    adjusterEmail: typeof body.adjusterEmail === 'string' ? body.adjusterEmail.trim() || null : null,
