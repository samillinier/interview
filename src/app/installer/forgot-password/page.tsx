        ...
        >
          ...
          <div className="space-y-3">
            <Link
              ...
              className="block w-full py-3 bg-brand-green text-white rounded-xl font-medium hover:bg-brand-green-dark transition-colors text-center"
            >
              Back to Login
            </Link>
      ...
      >
        <div className="bg-white rounded-3xl shadow-xl shadow-primary-900/5 p-8 md:p-12">
          ...
          <div className="mt-6 space-y-3 text-center">
            <Link
              href="/installer/login"
              className="block text-sm text-primary-600 hover:text-primary-900 transition-colors"
            >
              ← Back to Login
            </Link>
            <p className="text-xs text-primary-400">
