...
export function PropertyMobileMenu({ pathname, notificationCount = 0, onLogout }: Props) {
          ...
          <div className="bg-white rounded-2xl p-4 mb-6 shadow-sm border border-white/30">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <div className="font-bold text-primary-900 text-base truncate">Property Portal</div>
