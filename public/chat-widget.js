...
(function () {
  ...
  style.textContent = [
    ...
    '.fis-chat-launcher .fis-bubble { display: flex; align-items: center; justify-content: center; width: 44px; height: 44px; border-radius: 9999px; background: rgba(140,182,60,0.15); }',
